...
function togglePromptLogs(index: number) {
...
<template>
  <div class="max-w-4xl mx-auto p-4">
    <template v-if="conversation">
      ...
      <div class="mb-4 text-sm text-midnight-600 dark:text-midnight-200">
      ...
      <div class="space-y-6">
        <div
          ...
          :key="index"
          class="rounded-lg shadow-md overflow-hidden dark:shadow-midnight-700"
        >
          <MessageBubble
    ...
    <div v-else class="flex justify-center items-center h-64" role="status">
      <svg class="animate-spin h-8 w-8 text-midnight-500 dark:text-midnight-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
