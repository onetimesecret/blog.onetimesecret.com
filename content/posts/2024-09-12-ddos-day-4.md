...
Here's a link to the python script that generates the chart: [requests_chart_professional.py](/archive/blog/2024/sept/professional_chart.py) data file: [requests-per-second.txt](/archive/blog/2024/sept/requests-per-second.txt)
