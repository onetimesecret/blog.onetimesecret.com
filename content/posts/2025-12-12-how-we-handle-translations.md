...
badge:
  label: Process
image:
  src: /img/blog/blog/2025/20251212-delano-translating.jpg
readingTime: 3
draft: true
---
...
What holds it together: for each language I create two reference documents:
...
There are still strange word choices and grammatical mistakes out there. I don't want this to come across like I think this ramshackle process is god's gift to the world. It wouldn't be feasible at all without generous help from people, not to mention all the human content that LLMs have consumed to make what they do possible.

![](https://i.makeagif.com/media/10-06-2021/AO0o3Q.gif)

If you set the playback speed to 4x and skip ahead to about a minute in, [this is basically a live feed](https://www.youtube.com/watch?v=USRN6FUCYgU) of how I look working this process.
...
If you're interested, fork the repo, update locale files in `src/locales/{lang}/`, and submit a PR. Check the glossary and language notes in our [documentation repo](https://docs.onetimesecret.com). It takes me a while sometimes to respond depending on what I'm working on but I always review and reply.
